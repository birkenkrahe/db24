...
- [[https://github.com/birkenkrahe/db24/blob/main/img/having_count.png][This figure]] shows what's going on:
...
- How does this align with the pipeline ([[https://github.com/birkenkrahe/db24/blob/main/img/select_phases.png][see figure]])?
