...
* Test results: Not too shabby for now (5')
#+attr_html: :width 400px:
[[../img/test_1.png]]
#participants = 14/14
#+attr_html: :width 400px:
...
- I will share my sample solution before the next class.

- If you're NOT comfortable of using Emacs Org-mode with SQLite, let me know!
