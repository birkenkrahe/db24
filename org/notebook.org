...
3) Can you experiment with the data in the DataCamp lesson?
   #+attr_html: :width 400px:
...
** TODO Watch SQL vs NoSQL or MySQL vs MongoDB (video, 20 min) (Apr 16)
...
* Week 13 - Joins and subqueries in SQLite
