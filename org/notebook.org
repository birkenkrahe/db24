...
* Week 12 - More ERD - MySQL - Subqueries and Joins
#+attr_html: :width 600px:
[[../img/eclipse.png]]
...
- Useful process: "client brief"
  ...
  + Project brief:
    1. Design and build a tailor-made, bespoke, relational database his
       business that allows him to capture and store all of the
       important information and data that the business generates.
  ...
  + Approach:
    1. spec out all the field for the data to be collected
...
- Review:
  1) How would you define the following relationship using crow's foot:
     - An employee need not supervise other employees but he can
...
** TODO Review DataCamp: Schemas and Normalization

** TODO Subqueries and Joins in SQLite
