...
** Test 3 coming up (deadline Thursday 7 March)
...
* Week 8 - Projects / DB browser / SELECT
#+attr_html: :width 400px:
[[../img/week_8.webp]]

** TODO What does "creating a database" mean?
...
beginners (15 min video by Adam Finer, 2022) - shared in Google [[https://chat.google.com/room/AAAAEZSJ81g/zgS4qWacXLw/zgS4qWacXLw?cls=10][Chat]].

** TODO Project update (pair exercise) - 30 min
...
1) (In pairs) discuss what makes projects successful?
2) What makes database projects successful?
3) What database technology do you need for your project?

Longer pair exercise:
- Now, *get together in pairs* and *explain your project* and your
  *progress* (or lack thereof) to your partner (10 min)

- Your partner will then introduce your project to everyone else (20 min):
...
** TODO DataCamp review: Filtering records / aggregate functions

** TODO =SELECT= lecture / codealong / practice
