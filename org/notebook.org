...
** DONE Types of database management systems (Beaulieu, 2012)
...
1. Emacs customization:
   - =org-tempo-keywords-alist=: redefine <S <H
   - =org-structure-template-alist=: redefine <sqlite <p <r
2. Continue SQLite practice with ~foods.sql~ (Source: Kreibich, 2014).


** TODO Due next week: your project proposal ([[https://lyon.instructure.com/courses/2254/assignments/24826][Canvas]]/[[https://drive.google.com/drive/folders/1Ezbgo7x0tjbkf1lJ1eSSQPCpudIPZqcC?usp=sharing][GDrive]])
