...
- [ ] Review: video "Fundamental concepts of DB management"
...
** 10 Review questions for "Fundamentals of DBMS" ([[https://youtu.be/o36Z_OqC2ac?si=z9eobmcn7bfeS_lp][video]])
...
13 min (includes NoSQL and graph database examples).
