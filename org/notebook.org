...
- [ ] (Bonus) assignment: Emacs tutorial (upload screenshot to Canvas)
- [ ] PC install Emacs + SQLite3! I'll help you after class (see [[https://chat.google.com/room/AAAAEZSJ81g/gCgKDYojP8k/gCgKDYojP8k?cls=10][chat]])
...
** IN PROGRESS Practice: First literate SQLite database
...
~tinyurl.com/firstSQLite~ and open it in Emacs.
