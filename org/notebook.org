...
* DONE Week 11 - Entity-Relationship Diagrams (ERD)
#+attr_html: :width 400px:
[[../img/week_11.png]]
...
* DONE Week 12 - Normalization and ERD practice
#+attr_html: :width 600px:
[[../img/eclipse.png]]
...
** TODO Project: 2nd sprint review ... O Romeo Where Art Thou?
...
** TODO Finish ERD/ORM practice

See practice file [[https://tinyurl.com/erd-practice][tinyurl.com/erd-practice]], which we started last time:

1) Draw ERD for simple ~student~ / ~lecturer~ database.
2) Download SQL from ERD and get it to run.
3) Upload SQL to ERD tool to see the diagram.
4) Compare the results.


** TODO Watch SQL vs NoSQL or MySQL vs MongoDB (video, 20 min) [[https://youtu.be/ZS_kXvOeQ5Y?si=YEV1RuR8K4UT63RQ][(YouTube)]]
...
** READ Video: PostgreSQL vs. MySQL ([[https://youtu.be/btjBNKP49Rk?si=e_TxDMKJpH02VE-Q][YouTube]])
...
** NEXT Subqueries and Joins in SQLite


** NEXT Install and learn to use MySQL via XAMPP


* Week 14 - Database views and database management 

* Week 15 - Tue: wrap-up - Thu: Presentations
